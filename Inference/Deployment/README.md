...
1. Run `Download_Model_From_HuggingFace.ipynb` to download the model from Hugging Face and save it to the `models` directory.

2. Then build the container locally and give it a tag

    ```bash
    docker build -t local/dyu-fr-inference-joeynmt-v27.0 .
    ```
